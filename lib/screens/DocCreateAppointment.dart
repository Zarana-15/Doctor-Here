...
class DocCreateAppointment extends StatefulWidget {
  // static String drname;
  // static String timing;
  // static String druid;
  @override
  _DocCreateAppointmentState createState() => _DocCreateAppointmentState();
}

class _DocCreateAppointmentState extends State<DocCreateAppointment> {
